...
<html lang="en">
  ...
  <body>
      ...
      <table>
          ...
          <?php 
           $sql = "SELECT * FROM `orders` ORDER BY `oderid` DESC";
          ...
          <tr >
          <td>
          <span><?php echo $data['custaddress1'] ?></span>
          <p><?php echo $data['custaddress2'] ?></p>
          <p><?php echo$data['custpincode'] ?></p>
          </td>
          
          <td><p><?php echo $data['custnumber'] ?></p></td>
          <td><p><?php echo $data['ptotal'] ?></p></td>
          <td><p><?php echo $data['pmethod'] ?></p></td>
          <td><p><?php echo $data['custname'] ?></p></td>
